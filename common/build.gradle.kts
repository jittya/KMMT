...
kotlin {
    ...
    cocoapods {
        summary = "KMMT Common module for keeping shared things"
    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                api(Dependencies.KMM.Koin.Core)
                api(Dependencies.KMM.Coroutines.Core)
                api(Dependencies.KMM.Serialization.Json)
            }
        }
